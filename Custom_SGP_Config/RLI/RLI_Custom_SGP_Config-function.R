	...
	if (content_area=="EARLY_LITERACY" & testing.window=="FALL") {### EARLY_LITERACY/FALL
		tmp.list <- list(
			...
			EARLY_LITERACY.SF.config=list(
				...
				sgp.projection.grade.sequences=list(c('PK.3', 'K.1'), c('K.3', '1.1'), c('1.3', '2.1'), c('2.3', '3.1')),
	...
	if (content_area=="EARLY_LITERACY" & testing.window=="WINTER") {### EARLY_LITERACY/WINTER
		tmp.list <- list(
			EARLY_LITERACY.FW.config=list(
				...
				sgp.projection.grade.sequences=list(c('PK.1', 'PK.2'), c('K.1', 'K.2'), c('1.1', '1.2'), c('2.1', '2.2'), c('3.1', '3.2')),
	...
	if (content_area=="EARLY_LITERACY" & testing.window=="SPRING") {### EARLY_LITERACY/SPRING
		tmp.list <- list(
			...
			EARLY_LITERACY.FS.config=list(
				...
				sgp.projection.grade.sequences=list(c('PK.1', 'PK.3'), c('K.1', 'K.3'), c('1.1', '1.3'), c('2.1', '2.3'), "NO_PROJECTIONS"),
				sgp.projection.sequence="EARLY_LITERACY_FSF"),
			EARLY_LITERACY.WS.config=list(
				...
				sgp.projection.grade.sequences=list(c('PK.2', 'PK.3'), c('K.2', 'K.3'), c('1.2', '1.3'), c('2.2', '2.3'), c('3.2', '3.3')),
