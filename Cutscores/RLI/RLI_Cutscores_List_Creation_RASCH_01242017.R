...
rli.cs.long <- fread('Base_Files/cutscores_including_unlinked_grades_RASCH_01242017.txt')
rli.cs.long[,c("iMinSS", "iMaxSS"):=NULL]
setnames(rli.cs.long, c("vchRegionCode", "StateTest", "Subject", "Grade", "ProficiencyLevel", "vchProficiency", "MinSS", "MaxSS", "linked", "ProfFlag"))
