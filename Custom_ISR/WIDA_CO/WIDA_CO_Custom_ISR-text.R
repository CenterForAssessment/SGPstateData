...
highest performance, the levels are: Entering, Emerging, Eeveloping, Expanding, Bridging, and Reaching. The overall score and proficiency
level are presented for your student in this report.
...
compares to other students with similar previous ACCESS for ELLs scores. These student growth percentile scores range from 1 (lowest growth)
to 99 (highest growth). Percentiles are not percent correct scores, and do not reflect students' achievement levels. Students with
low test scores can achieve high student growth percentiles, if they make substantial progress since the previous year's assessment, compared
to their peers.
...
conversations with your child's school and teachers, to discuss questions such as:
      ...
      *  What steps can we take since my student's growth wasn't good enough to reach English Language Proficiency?
      *  Is my daughter's academic growth enough to move her to \"Bridging\" level next year?
      *  What will it take for my student to move up to the \"Reaching\" level next year?

For more information please visit www.cde.state.co.us/accountability/englishlanguageproficiencygrowth or contact 303-866-6763."
...
se compara con el de estudiantes en los a\u{F1}os anteriores que alcanzaron similar puntuaci\u{F3}n en su evaluaci\u{F3}n ACCESS for ELL. Estos
porcentajes de crecimiento estudiantil oscilan entre 1 (bajo crecimiento) y 99 (alto crecimiento). Los porcentajes no son porcentajes de calificaciones,
 y no reflejan los niveles de logro de los estudiantes. Los estudiantes con bajas calificaciones en sus ex\u{E1}menes pueden obtener altos
porcentajes de crecimiento estudiantil, si comparados con sus compa\u{F1}eros, han progresado sustancialmente en su dominio del idioma ingl\u{E9}s
...
Para obtener m\u{E1}s informaci\u{F3}n visite: www.cde.state.co.us/accountability/englishlanguageproficiencygrowth o llamar 303-866-6763."
