`make.custom.isr` = function() {
  ...
  pushViewport(custom.isr$Grid_Objects$report.vp)
    ...
    grid.text(x = 0.05, y = 0.5, paste("GTID:", student_number),
              gp = gpar(fontface = "bold", fontfamily = "Helvetica-Narrow", col = "white", cex = 0.9),
    ...
    grid.text(x = 0.05, y = 0.5, paste("Last Name:", gsub(" ", "-", LAST_NAME)),
              gp = gpar(fontface = "bold", fontfamily = "Helvetica-Narrow", col = "white", cex = 0.9),
              just = "left", default.units = "native")
    popViewport()
    ...
    grid.text(x = 0.025, y = 0.5, custom.isr$Report_Text,
              gp = gpar(fontfamily = "Helvetica-Narrow", col = "black", cex = 0.775), # cex = 0.825
              just = "left", default.units = "native")
    popViewport()
