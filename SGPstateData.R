...
SGPstateData[["RLI"]][["SGP_Configuration"]] <- list(
				...
				output.column.order=list(
					SGPercentiles=c('ID','SGP_BASELINE_ORDER_1','SGP_BASELINE_ORDER_2','SGP_BASELINE','SCALE_SCORE_PRIOR','SGP_LEVEL_BASELINE',
						'SGP_NORM_GROUP_BASELINE','SCALE_SCORE_PRIOR_STANDARDIZED', 'SGP_NORM_GROUP_BASELINE_SCALE_SCORES'),
					SGProjection=c('ID','STATE',
						...
						'CATCH_UP_KEEP_UP_STATUS_INITIAL_CURRENT','MOVE_UP_STAY_UP_STATUS_INITIAL_CURRENT','GROUP', 'SGP_PROJECTION_GROUP_SCALE_SCORES'),
